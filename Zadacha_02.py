...
система автоматического сбора черники. Эта система состоит из управляющего модуля и нескольких собирающих модулей. Собирающий
...
import random
list_1 = list(random.randint(1, 5) for i in range(int(input('Введите кол-во кустов: '))))
print(list_1)
...
if a == 1:
    count = list_1[0] + list_1[1] + list_1[-1]
elif a == len(list_1):
    count = list_1[-2] + list_1[-1] + list_1[0]
else:
    count = list_1[a-1] + list_1[a-2] + list_1[a]
print(count, 'ягод')